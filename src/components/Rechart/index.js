                ...
                <AreaChart  data={data} 
                    ...
                    <defs>
                        ...
                        <linearGradient id="colorRed" x1="0" y1="0" x2="0" y2="1">
                            <stop offset="5%" stopColor="#ce3734" stopOpacity={0.8}/>
                            <stop offset="95%" stopColor="#ce3734" stopOpacity={0}/>
                        </linearGradient>
                    </defs>
                    <XAxis dataKey="date" />
                    ...
                    <Area type="monotone" dataKey="totaldeceased" stroke="#ce3734" fillOpacity={1} fill="url(#colorRed)" />
                </AreaChart>
            </ResponsiveContainer>
        </>
    )
